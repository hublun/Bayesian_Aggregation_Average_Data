...
// valogit
auto valogit(const double& va, std::ostream* pstream__);
RcppExport SEXP sourceCpp_1_valogit(SEXP vaSEXP, SEXP pstream__SEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(valogit(va, pstream__));
    return rcpp_result_gen;
END_RCPP
}
// inv_valogit
auto inv_valogit(const double& tva, std::ostream* pstream__);
RcppExport SEXP sourceCpp_1_inv_valogit(SEXP tvaSEXP, SEXP pstream__SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const double& >::type tva(tvaSEXP);
    Rcpp::traits::input_parameter< std::ostream* >::type pstream__(pstream__SEXP);
    rcpp_result_gen = Rcpp::wrap(inv_valogit(tva, pstream__));
    return rcpp_result_gen;
END_RCPP
}
// evaluate_model
auto evaluate_model(const Eigen::Matrix<double,-1,1>& x, const std::vector<int>& DRUG, const double& Lalpha_0, const double& Lalpha_s, const double& lkappa, const double& lEmax, const double& delta, const Eigen::Matrix<double,-1,1>& eta_Lalpha_0, const Eigen::Matrix<double,-1,1>& eta_lkappa, const double& sigma_Lalpha_0, const double& sigma_lkappa, std::ostream* pstream__);
RcppExport SEXP sourceCpp_1_evaluate_model(SEXP xSEXP, SEXP DRUGSEXP, SEXP Lalpha_0SEXP, SEXP Lalpha_sSEXP, SEXP lkappaSEXP, SEXP lEmaxSEXP, SEXP deltaSEXP, SEXP eta_Lalpha_0SEXP, SEXP eta_lkappaSEXP, SEXP sigma_Lalpha_0SEXP, SEXP sigma_lkappaSEXP, SEXP pstream__SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,1>& >::type x(xSEXP);
    Rcpp::traits::input_parameter< const std::vector<int>& >::type DRUG(DRUGSEXP);
    Rcpp::traits::input_parameter< const double& >::type Lalpha_0(Lalpha_0SEXP);
    Rcpp::traits::input_parameter< const double& >::type Lalpha_s(Lalpha_sSEXP);
    Rcpp::traits::input_parameter< const double& >::type lkappa(lkappaSEXP);
    Rcpp::traits::input_parameter< const double& >::type lEmax(lEmaxSEXP);
    Rcpp::traits::input_parameter< const double& >::type delta(deltaSEXP);
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,1>& >::type eta_Lalpha_0(eta_Lalpha_0SEXP);
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,1>& >::type eta_lkappa(eta_lkappaSEXP);
    Rcpp::traits::input_parameter< const double& >::type sigma_Lalpha_0(sigma_Lalpha_0SEXP);
    Rcpp::traits::input_parameter< const double& >::type sigma_lkappa(sigma_lkappaSEXP);
    Rcpp::traits::input_parameter< std::ostream* >::type pstream__(pstream__SEXP);
    rcpp_result_gen = Rcpp::wrap(evaluate_model(x, DRUG, Lalpha_0, Lalpha_s, lkappa, lEmax, delta, eta_Lalpha_0, eta_lkappa, sigma_Lalpha_0, sigma_lkappa, pstream__));
    return rcpp_result_gen;
END_RCPP
}
// pretty_print
void pretty_print(const Eigen::Matrix<double,-1,-1>& x, std::ostream* pstream__);
...
// colMeans
auto colMeans(const Eigen::Matrix<double,-1,-1>& y, std::ostream* pstream__);
RcppExport SEXP sourceCpp_1_colMeans(SEXP ySEXP, SEXP pstream__SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,-1>& >::type y(ySEXP);
    Rcpp::traits::input_parameter< std::ostream* >::type pstream__(pstream__SEXP);
    rcpp_result_gen = Rcpp::wrap(colMeans(y, pstream__));
    return rcpp_result_gen;
END_RCPP
}
// robust_cov
auto robust_cov(const Eigen::Matrix<double,-1,-1>& y, const Eigen::Matrix<double,1,-1>& ym, std::ostream* pstream__);
RcppExport SEXP sourceCpp_1_robust_cov(SEXP ySEXP, SEXP ymSEXP, SEXP pstream__SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,-1>& >::type y(ySEXP);
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,1,-1>& >::type ym(ymSEXP);
    Rcpp::traits::input_parameter< std::ostream* >::type pstream__(pstream__SEXP);
    rcpp_result_gen = Rcpp::wrap(robust_cov(y, ym, pstream__));
    return rcpp_result_gen;
END_RCPP
}
// mvn_approx_lpdf
auto mvn_approx_lpdf(const Eigen::Matrix<double,-1,1>& y_prime_bar, const Eigen::Matrix<double,-1,1>& x_prime, const int& J_prime, const int& DRUG_prime, const Eigen::Matrix<double,-1,1>& delta, const double& Lalpha_0, const double& Lalpha_s, const double& lkappa, const double& lEmax, const double& sigma_Lalpha_0, const double& sigma_lkappa, const double& sigma_y, const Eigen::Matrix<double,-1,-1>& xi, std::ostream* pstream__);
RcppExport SEXP sourceCpp_1_mvn_approx_lpdf(SEXP y_prime_barSEXP, SEXP x_primeSEXP, SEXP J_primeSEXP, SEXP DRUG_primeSEXP, SEXP deltaSEXP, SEXP Lalpha_0SEXP, SEXP Lalpha_sSEXP, SEXP lkappaSEXP, SEXP lEmaxSEXP, SEXP sigma_Lalpha_0SEXP, SEXP sigma_lkappaSEXP, SEXP sigma_ySEXP, SEXP xiSEXP, SEXP pstream__SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,1>& >::type y_prime_bar(y_prime_barSEXP);
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,1>& >::type x_prime(x_primeSEXP);
    Rcpp::traits::input_parameter< const int& >::type J_prime(J_primeSEXP);
    Rcpp::traits::input_parameter< const int& >::type DRUG_prime(DRUG_primeSEXP);
    Rcpp::traits::input_parameter< const Eigen::Matrix<double,-1,1>& >::type delta(deltaSEXP);
    Rcpp::traits::input_parameter< const double& >::type Lalpha_0(Lalpha_0SEXP);
    Rcpp::traits::input_parameter< const double& >::type Lalpha_s(Lalpha_sSEXP);
    Rcpp::traits::input_parameter< const double& >::type lkappa(lkappaSEXP);
    Rcpp::traits::input_parameter< const double& >::type lEmax(lEmaxSEXP);
    ...
    Rcpp::traits::input_parameter< std::ostream* >::type pstream__(pstream__SEXP);
    rcpp_result_gen = Rcpp::wrap(mvn_approx_lpdf(y_prime_bar, x_prime, J_prime, DRUG_prime, delta, Lalpha_0, Lalpha_s, lkappa, lEmax, sigma_Lalpha_0, sigma_lkappa, sigma_y, xi, pstream__));
    return rcpp_result_gen;
END_RCPP
}
